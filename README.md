...
**[freespacestore.pages.dev](https://freespacestore.pages.dev)** — Free interactive space & orbital mechanics simulations. No signup, no install, runs in your browser.

## What is this?

FreeSpaceStore is part of [Open Frontier](https://freeprostores.pages.dev) — a collection of free educational simulation stores covering robotics, quantum computing, biology, chip design, space, and blockchain.
...
- **Discord:** [discord.gg/openfrontier](https://discord.gg/openfrontier) (#space channel)
- **Issues:** [GitHub Issues](https://github.com/freespacestore-online/platform/issues) for bugs & ideas
